...
inputPath = "/home/rambotcc/TCC/raw-merge/raw_dataset/" # ex) /home/ubuntu/raw_dataset/, raw_dataset directory must include each city's data separately. you can follow below instruction.
'''
...
outputPath = "/home/rambotcc/TCC/raw-merge/merged_output" # output will be generated in this directory automatically, you can change it.
...
def getTLSA(filename, time, dnMap):
    ...
    while True:
        ...
        # print("time",time)
        # print("city",line[1])
        dnMap[name] = {"domain":dn, "port":port, "time":time, "city":"saopaulo"}
        print(dnMap)
...
if __name__ == "__main__":
    ...
    # ex) python3 raw-merge.py 211104 211110 saopaulo
